...
export const ServiceProviderVerification = () => {
    // const theme = createTheme();
    ...
    const handleSubmit = (event) => {
      ...
      const handleOnClick = async (e) => {
        ...
        await axios.post("http://localhost:8082/serviceprovider/provider_update_request?provider_id="+providerId+"&description="+description)
        .then((response) => {
